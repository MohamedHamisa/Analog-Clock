from tkinter import * #to make a GUI 
from PIL import Image,ImageTk,ImageDraw    #ImageTK to add user images to the app, Draw to create and modify photoobjects from PIL images
...
class Clock:
    def __init__(self,root):
        self.root=root #to create a class that you can access when you call sel.root
